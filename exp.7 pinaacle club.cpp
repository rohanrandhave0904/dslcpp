...
cout<<"1.ADD MEMBER\n"<<"2.DELETE MEMBER\n"<<"3.SEARCH MEMBER\n"
<<"4.DISPLAY LIST OF THE MEMBER\n"<<"5.DISPLAY COUNT OF MEMBER\n"<<"6.CONCATINATION OF LIST\n"<<"\n\nEnter your Choice :";
cin>>val;
if(val==1)
{
    cout<<"\n1.PRESIDENT\n2.MEMBER\n3.SECREATARY\nENTER YOUR CHOICE :";
...
{
    cout<<"ENTER THE NUMBER OF MEMBERS OF THE OTHER DIVISION :";
    cin>>val2;
    for(k=0;k<val2;k++)
    {
        head1=create();
    ...
    concat(head,head1);
    cout<<"CONCATINATED CHOICE :\n";
    display(head);
    fun();
}
else{
    cout<<"ENATER VALID CHOICE!";
    fun();
}
}
int main()
